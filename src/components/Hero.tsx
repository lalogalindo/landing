...
export const Hero = () => {
  ...
  const metrics = [
    ...
    { label: 'Horas ahorradas', value: '120', tone: 'text-blue-500' },
    { label: 'Procesos activos', value: '14', tone: 'text-indigo-500' },
  ];

  return (
    <section className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,#dbeafe_0,#f8fbff_34%,#ffffff_68%)] pt-28 lg:pt-32">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -left-32 top-20 h-80 w-80 rounded-full bg-blue-300/30 blur-3xl" />
        <div className="absolute right-0 top-10 h-[34rem] w-[34rem] rounded-full bg-indigo-200/40 blur-[110px]" />
        <div className="absolute bottom-10 left-1/2 h-64 w-64 rounded-full bg-cyan-200/30 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-14 px-4 pb-20 sm:px-6 lg:grid-cols-[0.92fr_1.08fr] lg:px-8 lg:pb-28">
        <motion.div
          ...
          className="max-w-2xl"
        >
          <span className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-white/80 px-4 py-2 text-sm font-semibold text-brand-700 shadow-sm backdrop-blur">
          ...
          <h1 className="mt-7 text-5xl font-black tracking-[-0.055em] text-brand-900 sm:text-6xl lg:text-7xl">
            {t('hero.title1')}{' '}
            <span className="relative inline-block text-transparent bg-clip-text bg-gradient-to-r from-brand-accent via-blue-600 to-indigo-600">
              {t('hero.title2')}
              <span className="absolute -bottom-2 left-0 h-3 w-full rounded-full bg-blue-200/60 -z-10" />
            </span>
          </h1>
        ...
        >
          <div className="absolute -inset-8 rounded-[3rem] bg-gradient-to-br from-blue-300/30 via-white/0 to-indigo-400/20 blur-2xl" />
          <div className="relative rounded-[2rem] border border-white/80 bg-white/85 p-3 shadow-[0_30px_100px_rgba(37,99,235,0.22)] backdrop-blur-xl">
            <div className="overflow-hidden rounded-[1.55rem] border border-brand-100 bg-slate-950">
              <div className="flex items-center justify-between border-b border-white/10 bg-white/[0.04] px-5 py-4">
                ...
                <span className="rounded-full bg-blue-500/15 px-3 py-1 text-xs font-bold text-blue-200">MercSoft OS</span>
              </div>
              ...
              <div className="grid gap-4 p-4 sm:grid-cols-[1.1fr_0.9fr] sm:p-6">
                <div className="rounded-3xl bg-white p-5 shadow-2xl">
                  ...
                  <div className="mt-5 h-24 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600 p-4 text-white">
                    <p className="text-xs font-semibold text-blue-100">Automatización activa</p>
                  ...
                  >
                    <div className="mb-4 flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-300">Responde, califica y agenda</p>
                      </div>
                    </div>
                    <div className="space-y-3 text-sm">
                      <p className="w-4/5 rounded-2xl rounded-bl-sm bg-white/15 p-3 text-slate-100">¿Tienen integración con mi CRM?</p>
                      <p className="ml-auto w-5/6 rounded-2xl rounded-br-sm bg-emerald-400 p-3 font-semibold text-slate-950">Sí. Detecté tu stack y preparo el flujo.</p>
                    </div>
                  </motion.div>
